  ...
  return (
    ...
    >
      {showBack && (
        <button
          onClick={() => navigate(-1)}
          className="absolute -top-10 left-0 z-[100] p-2.5 bg-white/90 dark:bg-slate-700/90 backdrop-blur-md shadow-sm hover:shadow-md hover:bg-white dark:hover:bg-slate-600 rounded-xl transition-all duration-300 text-slate-600 dark:text-slate-300 active:scale-90 group"
          title={t('common.back')}
        >
