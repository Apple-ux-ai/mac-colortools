...
const JapaneseTraditionalColors: React.FC = () => {
  ...
  const japanData: CategoryInfo[] = isCategorized 
    ...
    : [{ category: t('traditional.japanCategoryDefault'), colors: rawJapanData as ColorInfo[] }];

  return (
    <PageContainer title={t('traditional.japan')} hideDefaultTitle>
      <div className="space-y-8 max-w-7xl mx-auto">
        <div className="bg-white dark:bg-slate-800 p-6 rounded-[2rem] shadow-sm border border-slate-100 dark:border-slate-600 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center text-white shadow-lg shadow-indigo-100 dark:shadow-indigo-900/30 border-2 border-white/50 dark:border-slate-600/50">
              <span className="text-2xl">👘</span>
            </div>
            <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100 tracking-tight">{t('traditional.japanTitle')}</h1>
          </div>
        </div>
        ...
        <div className="bg-indigo-50/50 dark:bg-indigo-900/20 p-8 rounded-xl border border-indigo-100 dark:border-indigo-800/50 space-y-4">
          <h3 className="text-indigo-600 dark:text-indigo-400 font-bold text-lg">{t('traditional.japanAboutTitle')}</h3>
          <div className="space-y-3 text-indigo-500/90 dark:text-indigo-200/90 text-sm leading-relaxed">
            <p>{t('traditional.japanAbout1')}</p>
            <p>{t('traditional.japanAbout2')}</p>
            <div className="space-y-1 pl-4">
              <p>{t('traditional.japanAboutItem1')}</p>
              <p>{t('traditional.japanAboutItem2')}</p>
              <p>{t('traditional.japanAboutItem3')}</p>
              <p>{t('traditional.japanAboutItem4')}</p>
            </div>
            <p>{t('traditional.japanAbout3')}</p>
          </div>
        </div>
      </div>
    </PageContainer>
